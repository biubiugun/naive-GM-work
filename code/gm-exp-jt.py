...
#
obj_resize = (256, 256)
img1 = Image.open('/root/bigHW/data/WillowObject/WILLOW-ObjectClass/Car/Cars_000a.png')
img2 = Image.open('/root/bigHW/data/WillowObject/WILLOW-ObjectClass/Car/Cars_001b.png')
kpts1 = jt.Var(sio.loadmat('/root/bigHW/data/WillowObject/WILLOW-ObjectClass/Car/Cars_000a.mat')['pts_coord'])
kpts2 = jt.Var(sio.loadmat('/root/bigHW/data/WillowObject/WILLOW-ObjectClass/Car/Cars_001b.mat')['pts_coord'])
...
# [[ 66.2459893  199.89304813  17.30481283  58.71657754 119.89304813
#          123.18716578 124.12834225 243.18716578  15.89304813 169.77540107]
#         [165.19073084 163.3083779  116.87700535 110.60249554  90.52406417
#          141.34759358 174.60249554 146.36720143 155.77896613 115.62210339]]
...
plt.savefig('output/cnn_features_jt.png')
...
plt.savefig('output/pca-gm_jt.png')
...
plt.savefig('output/ipca-gm_jt.png')
...
print(grad_size)
plt.stem(grad_size)
plt.savefig('output/layer-grad-size_jt.png')
