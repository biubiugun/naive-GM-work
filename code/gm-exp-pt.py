...
#
obj_resize = (256, 256)
img1 = Image.open('data/WillowObject/WILLOW-ObjectClass/Duck/060_0000.png')
img2 = Image.open('data/WillowObject/WILLOW-ObjectClass/Duck/060_0001.png')
kpts1 = torch.tensor(sio.loadmat('data/WillowObject/WILLOW-ObjectClass/Duck/060_0000.mat')['pts_coord'])
kpts2 = torch.tensor(sio.loadmat('data/WillowObject/WILLOW-ObjectClass/Duck/060_0000.mat')['pts_coord'])
...
plt.savefig('output/cnn_features_pt.png')
...
plt.savefig('output/pca-gm_pt.png')
...
plt.savefig('output/ipca-gm_pt.png')
